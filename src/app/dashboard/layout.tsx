    ...
    return (
      <section className="mx-auto max-w-2xl rounded-3xl border border-white/70 bg-white/95 px-6 py-12 text-center shadow-sm" aria-live="polite">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-600">
          {language === "kk"
            ? "Қолжетімділікті тексеру мүмкін болмады. Сәлден кейін қайта көріңіз. Дайын материалдар тексеруден кейін ашылады."
            : "Не удалось проверить доступ. Подождите немного и попробуйте снова. Готовые материалы откроются после проверки."}
        </p>
        {error && (
          <button
            type="button"
