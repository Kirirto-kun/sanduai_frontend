...
const COPY = {
  ru: {
    ...
    network: "Не удалось связаться с сервисом. Подождите немного и попробуйте ещё раз.",
  ...
  kk: {
    ...
    network: "Қызметпен байланысу мүмкін болмады. Сәлден кейін қайталап көріңіз.",
