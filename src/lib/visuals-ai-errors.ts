...
const COPY = {
  ru: {
    ...
    connection: "Не удалось связаться с сервисом. Проверьте интернет и попробуйте ещё раз.",
    invalidInput: "Проверьте заполненные поля и попробуйте ещё раз.",
  },
  kk: {
    unavailable: "Суретті жасау мүмкін болмады. Қайталап көріңіз.",
    connection: "Қызметке қосылу мүмкін болмады. Интернетті тексеріп, қайталап көріңіз.",
